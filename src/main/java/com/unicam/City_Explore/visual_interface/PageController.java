...
public class PageController implements CommandLineRunner{
	...
	private void inizialize() {
		...
		this.userService.createUser("AUTHORIZED_CONTRIBUTOR", "AUTORIZED_CONTRIBUTOR", "AUTORIZED_CONTRIBUTOR", "AUTORIZED_CONTRIBUTOR@gmail.com", "AUTORIZED_CONTRIBUTOR", Role.AUTHORIZED_CONTRIBUTOR);
